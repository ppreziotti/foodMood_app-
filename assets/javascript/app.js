...
function lovePhoto() {
  ...
  var buttonDiv = $("<div>");
  var buttonHeading = $("<h2>").text("Still not satisfied?");
  var backButton = $("<button>").text("Go Back to Photos");
  backButton.addClass("btn btn-default");
  ...
  buttonDiv.append(startOverButton);
  lovePhotoDiv.append(buttonDiv);
...
// If the user clicks the go back button, execute showPhoto for the cuisine that was 
// already picked
$(document).on("click", "#back-btn", showPhoto);
